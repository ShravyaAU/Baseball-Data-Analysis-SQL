...
SELECT  nameGiven,
        DATEDIFF(YEAR, DATEFROMPARTS(birthYear, birthMonth, birthDay), debut) AS starting_age,
        DATEDIFF(YEAR, DATEFROMPARTS(birthYear, birthMonth, birthDay), finalGame) AS ending_age,
